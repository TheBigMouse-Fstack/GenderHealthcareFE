export const environment = {
  production: false,
  apiEndpoint: 'https://ghpvytjmmhlwhraxzdhj.supabase.co/functions/v1', // Đặt endpoint hoặc key ở đây
  mockEndpoint: 'https://e848c397-890a-4aea-b840-a054fa9ff65f.mock.pstmn.io',
  authorization:
